...
def effective_minutes(row):
    # Units-only version: ignore Billing Minutes/Hours; derive strictly from Units
...
def discrepancy_flag(row):
    # In units-only mode we don't compare billing minutes/hours; no discrepancy flag
    return False
